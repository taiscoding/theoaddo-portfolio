...
export class ParticleSystem {
     ...
     */
    get_render_data() {
        const ret = wasm.particlesystem_get_render_data(this.__wbg_ptr);
     ...
     */
    positions_ptr() {
        const ret = wasm.particlesystem_positions_ptr(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @param {number} x
     ...
     */
    set_mouse(x, y, active) {
        wasm.particlesystem_set_mouse(this.__wbg_ptr, x, y, active);
    }
    /**
     * @param {number} y
     */
    set_scroll(y) {
        wasm.particlesystem_set_scroll(this.__wbg_ptr, y);
    }
    /**
     * @param {number} w
     * @param {number} h
     */
    set_size(w, h) {
        wasm.particlesystem_set_size(this.__wbg_ptr, w, h);
    }
    /**
     * @param {number} dt
     */
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('wasm_particles_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
